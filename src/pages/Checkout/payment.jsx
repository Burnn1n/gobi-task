					...
					<Row>
						<Col sm="8">
							...
							<div className="payments">
								<div className={selected===1?"method active":"method"} onClick={()=>setSelected(1)}>
									<div className="icon">
								...
								<div className={selected===2?"method active":"method"} onClick={()=>setSelected(2)}>
									<div className="icon">
									<svg viewBox="0 0 36 37" fill="none" xmlns="http://www.w3.org/2000/svg">
								...
								<div className={selected===3?"method active":"method"} onClick={()=>setSelected(3)}>
